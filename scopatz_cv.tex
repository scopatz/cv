...
\begin{itemize}
\item
    \ressubheading{CNERG, The University of Wisconsin-Madison}{Madison, WI}
                  {Research Scientist, Engineering Pysics Department}
                  {June 2013 - present}
    \begin{itemize}
        \resitem{Cyclus: An agent-based, discrete time nuclear fuel cycle simulator.}
        \resitem{PyNE: The Nuclear Engineering Tool Kit.}
    \end{itemize}

\item
    \ressubheading{The FLASH Center, The University of Chicago}{Chicago, IL}
                  {Research Scientist, Postdoctoral Scholar, Astronomy 
...
\item
    \ressubheading{Enthought, Inc.}{Austin, TX}{Scientific Software Developer}
...
\begin{itemize}
\item
    \ressubheading{Research Scientist \& Postdoctoral Scholar}
                  {The University of Chicago}
                  {High Energy Density Physics}{November 2011 - present}
    \begin{itemize}
...
\item
    \ressubheading{Graduate Research Assistant}{The University of Texas at Austin}
...
\item
    \ressubheading{Summer Internship/Visiting Scientist}{Idaho National Laboratory}
...
\item
    \ressubheading{Undergraduate Research Assistant}
...
\item
    \ressubheading{Summer Internship/Visiting Scientist}
...
\item
    \ressubheading{PyNE}{Lead Developer}{The Nuclear Engineering Toolkit}
                  {April 2011 - present}
    \begin{itemize}
        ...
        \resitem{Workflow management tools (I/O support for other codes, fundamental 
                 data types, etc.)}
        \resitem{Website: \url{http://pynesim.org}}
    \end{itemize}

\item
    \ressubheading{yt}{Developer}{Astrophysical Simulation Analysis and Visualization}
                  {August 2012 - present}
    \begin{itemize}
...
\item
    \ressubheading{cyclus}{Input User Interface Lead}
...
\begin{itemize}
\item
    \ressubheading{HDF5 is for Lovers}{SciPy 2012, PyCon Canada 2012, \& PyData Silicon Valley 2013}{Instructor}{July 16, 2012;  November 10, 2012; March 18, 2013}
    \begin{itemize}
...
\item
    \ressubheading{NumFOCUS}{{\em 2011 - present}}{Board Member, Treasurer}{}

\item
    \ressubheading{American Physical Society}{{\em 2012 - present}}{Member}{}

\item
    \ressubheading{Python Software Foundation}{{\em 2013 - present}}{Fellow}{}
...
\item
    ...
    \begin{itemize}
        ...
        \resitem{{\bf Intermediate:} Fortran 77/90/95, Haskell, Java, JavaScript, Lua, 
                                     Powersim}
    \end{itemize}
