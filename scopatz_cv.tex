...
\item
    \ressubheading{CNERG, The University of Wisconsin-Madison}{Madison, WI}
                  {Associate Scientist, Engineering Pysics Department}
                  {June 2013 - present}
    \begin{itemize}
...
\begin{itemize}
\item
    \ressubheading{Associate Scientist}
    ...
    \begin{itemize}
        ...
        \resitem{Nuclear engineering toolkit development (PyNE).}
    \end{itemize}
...
\begin{itemize}
\item
    \ressubheading{Cyclus}{Project Lead}
...
\item
    \ressubheading{yt}{Developer}{Volumetric Data Analysis}
                  {August 2012 - present}
    \begin{itemize}
...
\begin{itemize}
\item
    \ressubheading{Scientific Computing with Python and SciPy}{African Institute for Mathematical Sciences}{Lecturer}{September 2013}
    \begin{itemize}
...
\item
    \ressubheading{Software Carpentry}{{\em 2011 - present}}{Instructor}{}
...
\item
    Markup Languages
    \begin{itemize}
        \resitem{{\bf Expert:} rST, \LaTeX, HTML, CSS, XML}
